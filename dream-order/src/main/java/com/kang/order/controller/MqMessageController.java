 ...
 */
@RestController
@RequestMapping("${moduleName}/mqmessage")
public class MqMessageController {
     ...
     */
    @RequestMapping("/list")
    @RequiresPermissions("${moduleName}:mqmessage:list")
    ...
    @RequiresPermissions("${moduleName}:mqmessage:info")
     ...
     */
    @RequestMapping("/save")
    @RequiresPermissions("${moduleName}:mqmessage:save")
    ...
    @RequiresPermissions("${moduleName}:mqmessage:update")
    ...
    @RequiresPermissions("${moduleName}:mqmessage:delete")
