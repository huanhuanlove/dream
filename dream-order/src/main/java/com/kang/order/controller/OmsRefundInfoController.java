...
import com.kang.order.${moduleName}.service.OmsRefundInfoService;
 ...
 */
@RestController
@RequestMapping("${moduleName}/omsrefundinfo")
public class OmsRefundInfoController {
     ...
     */
    @RequestMapping("/list")
    @RequiresPermissions("${moduleName}:omsrefundinfo:list")
    ...
    @RequiresPermissions("${moduleName}:omsrefundinfo:info")
     ...
     */
    @RequestMapping("/save")
    @RequiresPermissions("${moduleName}:omsrefundinfo:save")
    ...
    @RequiresPermissions("${moduleName}:omsrefundinfo:update")
    ...
    @RequiresPermissions("${moduleName}:omsrefundinfo:delete")
