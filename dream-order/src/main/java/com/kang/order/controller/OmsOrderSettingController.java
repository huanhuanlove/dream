...
import com.kang.order.${moduleName}.service.OmsOrderSettingService;
 ...
 */
@RestController
@RequestMapping("${moduleName}/omsordersetting")
public class OmsOrderSettingController {
     ...
     */
    @RequestMapping("/list")
    @RequiresPermissions("${moduleName}:omsordersetting:list")
    ...
    @RequiresPermissions("${moduleName}:omsordersetting:info")
     ...
     */
    @RequestMapping("/save")
    @RequiresPermissions("${moduleName}:omsordersetting:save")
    ...
    @RequiresPermissions("${moduleName}:omsordersetting:update")
    ...
    @RequiresPermissions("${moduleName}:omsordersetting:delete")
